...
author:
  - name: Mauricio Mardones
    affiliation: a,1,2
  - name: María José Zúñiga
    affiliation: a,b
address:
  - code: a
    address: Instituto de Fomento Pesquero (IFOP), Chile
  - code: b
    address: PhD, Antarctic and SubAntarctic Science, Universidad de Magallanes, Chile
...
git remote set-url origin  https://github.com/MauroMardones/mypaper.git 



lead_author_surname: Anonymous two
