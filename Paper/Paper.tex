...
\author[a,1,2]{Mauricio Mardones}
\author[a,b]{María José Zúñiga}

  \affil[a]{Instituto de Fomento Pesquero (IFOP), Chile}
  \affil[b]{PhD, Antarctic and SubAntarctic Science, Universidad de
Magallanes, Chile}
